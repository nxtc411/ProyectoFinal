...
public class InterfazPregunta18 extends javax.swing.JFrame {

    public InterfazPregunta18() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("18. ¿Depositas las baterías o pilas en los puntos seleccionados?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        InterfazPregunta19 Ipregunta19 = new InterfazPregunta19();
        Ipregunta19.setVisible(true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazPregunta18().setVisible(true);
            }
        });
    }
