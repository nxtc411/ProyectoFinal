...
public class InterfazPregunta07 extends javax.swing.JFrame {

    public InterfazPregunta07() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("7. ¿Cierras la llave al enjabonar los platos?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        InterfazPregunta08 Ipregunta8 = new InterfazPregunta08();
        Ipregunta8.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazPregunta07().setVisible(true);
            }
        });
    }
