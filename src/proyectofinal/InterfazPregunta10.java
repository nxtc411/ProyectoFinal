...
public class InterfazPregunta10 extends javax.swing.JFrame {

    public InterfazPregunta10() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("10. ¿Apagas las luces cuando no las usas?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        InterfazPregunta11 Ipregunta11 = new InterfazPregunta11();
        Ipregunta11.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazPregunta10().setVisible(true);
            }
        });
    }
