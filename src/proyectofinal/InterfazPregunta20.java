...
public class InterfazPregunta20 extends javax.swing.JFrame {

    public InterfazPregunta20() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("20. ¿Depositas toda la basura doméstica en una sola bolsa?");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazPregunta20().setVisible(true);
            }
        });
    }
