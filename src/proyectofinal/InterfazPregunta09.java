...
public class InterfazPregunta09 extends javax.swing.JFrame {

    public InterfazPregunta09() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("9. ¿Desconectas tus equipos electrónicos cuando no los usas?");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, -1, -1));

        jLabel2.setText("Hablemos de la energía:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        InterfazPregunta10 Ipregunta10 = new InterfazPregunta10();
        Ipregunta10.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazPregunta09().setVisible(true);
            }
        });
    }
