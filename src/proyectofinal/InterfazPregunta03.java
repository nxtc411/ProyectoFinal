...
public class InterfazPregunta03 extends javax.swing.JFrame {

    public InterfazPregunta03() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("3. ¿Usas desodorante o cualquier otro producto en aerosol?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        InterfazPregunta04 Ipregunta4 = new InterfazPregunta04();
        Ipregunta4.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazPregunta03().setVisible(true);
            }
        });
    }
