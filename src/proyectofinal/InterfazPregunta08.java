...
public class InterfazPregunta08 extends javax.swing.JFrame {

    public InterfazPregunta08() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("8. ¿Cierras el grifo cuando te cepillas los dientes?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        InterfazPregunta09 Ipregunta9 = new InterfazPregunta09();
        Ipregunta9.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazPregunta08().setVisible(true);
            }
        });
    }
