...
public class InterfazPregunta15 extends javax.swing.JFrame {

    public InterfazPregunta15() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("15. ¿Utilizas bolsas de plástico a diario?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        setVisible(false);
        InterfazPregunta16 Ipregunta16 = new InterfazPregunta16();
        Ipregunta16.setVisible(true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazPregunta15().setVisible(true);
            }
        });
    }
